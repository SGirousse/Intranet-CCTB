...
/**
 * Telephone filter form base class.
 *
 ...
 */
abstract class BaseTelephoneFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('telephone_filters[%s]');
